...
# 2 sets of characters for better resolution
ASCII_CHARS = ["@", "#", "S", "%", "?", "*", "+", ";", ":", ",", ".", " ", "░", "▒", "▓", "█"]
ASCII_CHARS_2 =  [' ','.',':','-','=','+','*','#','%','@'] 

IMAGE_PATH = "brock.png"
PIL_GRAYSCALE = 'L'
PIL_WIDTH_INDEX = 0
PIL_HEIGHT_INDEX = 1
...
num_chars = len(ASCII_CHARS_2)  # Changed to use ASCII_CHARS_2
def pixel_to_ascii(image):
    pixels = image.getdata()
    ascii_str = ""
    for pixel_value in pixels:
        ascii_str += ASCII_CHARS_2[pixel_value * num_chars // 256]  # Map pixel to character from ASCII_CHARS_2
    return ascii_str
